              ...
              <div className="p-8 overflow-y-auto max-h-[calc(90vh-180px)]">
                {isAnalyzing ? (
                  ...
                  <>
                    ...
                    {/* Sugestão da IA */}
                    <div className="bg-gradient-to-r from-purple-50 to-purple-50 border border-purple-200 rounded-2xl p-5 mb-6">
                          ...
                          >
                            ...
                            <div className={`p-4 rounded-xl border-2 ${focusColors[block.focusLevel].bg} ${focusColors[block.focusLevel].border}`}>
                              <div className="flex items-start justify-between mb-2">
                                <div>
                                  <p className="text-sm font-bold text-purple-600">{block.timeBlock}</p>
              ...
              {!isAnalyzing && (
                <div className="border-t border-slate-200 px-8 py-4 bg-slate-50 flex gap-3">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-shadow"
                  >
                    Aplicar Organização
                  </motion.button>
                </div>
